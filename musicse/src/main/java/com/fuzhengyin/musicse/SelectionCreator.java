...
public final class SelectionCreator {
    private final Musicse mMusicse;
     ...
     *
     * @param musicse   a requester context wrapper.
     * @param mimeTypes MIME type set to select.
     */
    SelectionCreator(Musicse musicse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMusicse = musicse;
     ...
     * 1. com.zhihu.musicse.R.style.Matisse_Zhihu;
     * 2. com.zhihu.musicse.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is com.zhihu.musicse.R.style.Matisse_Zhihu.
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     * <p>
     * It's a redundant API with {@link Musicse#obtainResult(Intent)},
    ...
    public void forResult(int requestCode) {
        Activity activity = mMusicse.getActivity();
        if (activity == null) {
            return;
        }

        Intent intent = new Intent(activity, MusicseActivity.class);

        Fragment fragment = mMusicse.getFragment();
        if (fragment != null) {
