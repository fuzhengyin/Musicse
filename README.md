...
# Musicse
It's just Matisse, but for music!

[![Build Status](https://travis-ci.org/zhihu/Matisse.svg)](https://travis-ci.org/zhihu/Matisse) [ ![Download](https://api.bintray.com/packages/zhihu/maven/musicse/images/download.svg) ](https://bintray.com/zhihu/maven/musicse/_latestVersion)
...
dependencies {
    implementation 'com.zhihu.android:musicse:$latest_version'
}
```
